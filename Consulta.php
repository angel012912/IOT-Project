...
if(isset($_POST['ConsultaCO2'])){
    ...
    $valor = $_POST['CO2'];
    //Evalua que opcion seleccion�
    if($valor == 'Promedio'){
        //Dise�o de la tabla a desplegar
...
elseif(isset($_POST['ConsultaTemp'])){
    ...
    $valor = $_POST['TEMP'];
    //Se evalua la opcion que se ingres�
    if($valor == 'Promedio'){
        echo "<div class = 'card card-signin my-5 col-sm-9 mx-auto sombra' id = 'listaCons' style='text-align: center'>
                <table class=' table table-hover table-borderless '>
                <thead>
...
elseif(isset($_POST['ConsultaPerso'])){
    ...
    //Se evalua para cada campo del formulario si se ingreso o selecciono algun valor. Si s� se selecciono agrega al mensaje con el query principal el filtro necesario. 
    if($medicion != 'NADA'){
